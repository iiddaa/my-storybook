...
// ─── アプリナビゲーション用マルチカラーSVG定義 ───
// Figma node-id: 152:86（store）/ 152:91（analysis）/ 152:94（gear）

const ICON_MULTICOLOR = {
  store_nav: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  analysis_nav: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  gear_nav: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function buildSvgEl(name, size = 24) {
  if (ICON_MULTICOLOR[name]) {
    const tmp = document.createElement('span');
    tmp.innerHTML = ICON_MULTICOLOR[name];
