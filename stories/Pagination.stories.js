...
## 大量のデータを表示する［Pagination］と［無限スクロール］の使い分け

| | Pagination | 無限スクロール |
|---|---|---|
| **使い道** | 全件を正確に確認したい場合に利用する。<br>例：履歴、検索結果、リスト管理画面 | 「探索する」体験の場合に利用する。<br>例：ニュース、SNS、ギャラリー |
| **アクセス、参照のしやすさ** | ⭕️ 最後のデータへも直接アクセス可能。昇順確認なども可能。 | 🔺 奥深くにあるデータは探しづらい。パフォーマンス低下しやすい。 |
| **操作コスト** | 🔺 クリックが必要 | ⭕️ クリック不要 |
`;
